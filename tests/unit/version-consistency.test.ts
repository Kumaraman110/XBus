...
describe('version consistency (prevents the beta.3 install-rollback class)', () => {
  ...
  it('compatibility + schema are INDEPENDENT of the product version and stay at s10', () => {
  ...
  it('a generated provenance manifest (if built) embeds the product version + s10 tuple', () => {
